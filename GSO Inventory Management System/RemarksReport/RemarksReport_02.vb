...
Public Class RemarksReport_02
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_02.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_02
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_02 = New RemarksReport_02()
        rpt.Site = Me.Site
        Return rpt
    End Function
