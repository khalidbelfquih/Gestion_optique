...
Public Class RemarksReport_01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_01 = New RemarksReport_01()
        rpt.Site = Me.Site
        Return rpt
    End Function
