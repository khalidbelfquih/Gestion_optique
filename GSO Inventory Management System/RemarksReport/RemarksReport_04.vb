...
Public Class RemarksReport_04
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_04.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_04
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_04 = New RemarksReport_04()
        rpt.Site = Me.Site
        Return rpt
    End Function
