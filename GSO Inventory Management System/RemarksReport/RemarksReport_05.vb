...
Public Class RemarksReport_05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_05 = New RemarksReport_05()
        rpt.Site = Me.Site
        Return rpt
    End Function
