...
Public Class PrintReportFor_PO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.PrintReportFor_PO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintReportFor_PO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintReportFor_PO = New PrintReportFor_PO()
        rpt.Site = Me.Site
        Return rpt
    End Function
