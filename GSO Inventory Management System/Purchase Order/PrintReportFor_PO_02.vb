...
Public Class PrintReportFor_PO_02
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrintReportFor_PO_02.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.PrintReportFor_PO_02.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_person() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPrintReportFor_PO_02
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintReportFor_PO_02 = New PrintReportFor_PO_02()
        rpt.Site = Me.Site
        Return rpt
    End Function
