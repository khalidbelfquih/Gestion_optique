...
Public Class RemarksReport_06
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_06.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_06
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_06 = New RemarksReport_06()
        rpt.Site = Me.Site
        Return rpt
    End Function
