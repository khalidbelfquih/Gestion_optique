...
Public Class RemarksReport_03
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSO_Inventory_Management_System.RemarksReport_03.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemarksReport_03
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemarksReport_03 = New RemarksReport_03()
        rpt.Site = Me.Site
        Return rpt
    End Function
