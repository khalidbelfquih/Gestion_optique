...
Public Class PrintForm_01
    ...
    Private Sub PrintForm_01_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            conn.Close()
            Dim cryds As New PrintReportFor_PO_01
            cryds.SetDataSource(ds.Tables(0))
            cryds.SetParameterValue("person", ViewForm.usertxt.Text)
